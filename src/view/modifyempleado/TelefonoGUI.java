...
import model.dao.empleado.DatosTelefonoDao;
...
public class TelefonoGUI extends javax.swing.JFrame {
    ...
    public void actualizarTelefono() throws SQLException{
        ...
        if(getTfUsuario().getText().length()!=0
                ...
                && getTfTelefonoNuevo().getText().length()!=0){
            if(usuario.equals(getTfUsuario().getText())){
                if(contrasenia.equals(getTfContrasenia().getText())){
                    if(!telefonoAnt.equals(getTfTelefonoNuevo().getText())){
                        try {
                            DatosTelefono telefonoActualizar = new DatosTelefono();

                            telefonoActualizar.setUsuario(getTfUsuario().getText());
                            telefonoActualizar.setContrasenia(getTfContrasenia().getText());
                            telefonoActualizar.setTelefonoNuevo(getTfTelefonoNuevo().getText());

                            DatosTelefono telefonoActualizado =null;
                            DatosTelefonoDao d = new DatosTelefonoDao();
     ...
     */
    public String[][] formatoRegistros(ArrayList<DatosTelefono> consulta, int numeroColumnas){
        ...
        for (int i = 0; i < consulta.size(); i++) {            
            ...
            registros[i][2] = consulta.get(i).getTelefonoAnt();
        }
    ...
    public JTextField getTfTelefonoNuevo() {
        return tfTelefonoNuevo;
    }

    public void setTfTelefonoNuevo(JTextField tfTelefonoNuevo) {
        this.tfTelefonoNuevo = tfTelefonoNuevo;
    }
